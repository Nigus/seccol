...
public class PreferenceManagerCompat {
	...
	public static final String USE_WIFI_only = "use_wifi_force";
	public static final String USE_WIFI = "use_wifi";
	public static final String USE_2G="use_2g";
	public static final String USE_3G="use_2g";
	public static final String USE_4G="use_2g";
